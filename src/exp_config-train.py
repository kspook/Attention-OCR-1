...
class ExpConfig:
    ...
    #DATA_BASE_DIR = 'image-data/test-img/'		
    ...
    #DATA_PATH = 'test.txt' # path containing data file names and labels. Format: 	
    ...
    #OUTPUT_DIR = 'results_f64S' # output directory	
